...
$app->post('/api/Nexosis/deleteSession', function ($request, $response) {
    ...
    $optionalParams = ['sessionId'=>'sessionId'];
    $bodyParams = [''];
    ...
    try {
        ...
        if(in_array($resp->getStatusCode(), ['200', '201', '202', '203', '204'])) {
            ...
            if(empty($result['contextWrites']['to'])) {
                $result['contextWrites']['to']['status_msg'] = "Session successfully deleted!";
            }
        } else {

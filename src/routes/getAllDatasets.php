...
$app->post('/api/Nexosis/getAllDatasets', function ($request, $response) {
    ...
    $optionalParams = ['partialName'=>'partialName','page'=>'page','pageSize'=>'pageSize'];
    $bodyParams = ['partialName','page','pageSize'];

    $data = \Models\Params::createParams($requiredParams, $optionalParams, $post_data['args']);
    $requestBody = \Models\Params::createRequestBody($data, $bodyParams);

    $client = $this->httpClient;
    $query_str = "https://ml.nexosis.com/v1/data";

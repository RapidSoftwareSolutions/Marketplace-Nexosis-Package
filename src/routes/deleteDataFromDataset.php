...
$app->post('/api/Nexosis/deleteDataFromDataset', function ($request, $response) {
    ...
    $optionalParams = ['startDate'=>'startDate','endDate'=>'endDate','cascade'=>'cascade'];
    $bodyParams = ['startDate','endDate','cascade'];

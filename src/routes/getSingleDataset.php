...
$app->post('/api/Nexosis/getSingleDataset', function ($request, $response) {
    ...
    $optionalParams = ['startDate'=>'startDate','endDate'=>'endDate','page'=>'page','pageSize'=>'pageSize','include'=>'include'];
    $bodyParams = ['startDate','endDate','page','pageSize','include'];
